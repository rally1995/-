<template lang="pug">
    el-dialog.dialog(
        ...
        el-form.expand(
            ...
            :disabled="disabled")
            el-row
                template(v-for="(item, index) in form" v-if="typeof item.show === 'function' ? (item.show()!==false) : (item.show!==false)")
                    ...
                    el-col(
                        ...
                        el-form-item(
                            ...
                            el-select(
                                ...
                                :collapse-tags="item.collapse === 'collapse-tags'"
                                :disabled="item.disabled"
                                :placeholder="item.placeholder"
                                :readonly="item.readonly"
                                filterable
...
export default {
    ...
    watch: {
        v(val) {
            if (!val && this.form && this.form.length) {
                this.form.forEach(v => {
                    switch (v.type) {
                        case 'multiple':
                            v.value = [];
