...
export default {
    ...
    data() {
        return {
            ...
            tableData: [],
            apiProperty: ['className', 'cuttingSpecification'],
        };
    },
    computed: {
        ...mapState('sys', {
    ...
    methods: {
        ...
        getData() {
            ...
            this.$http.get(`/productionexe/cuttingprodparams/page`, {
                params
            }).then(({ data }) => {
        ...
        cellSave(row, finish, killLoading) {
            ...
            if (!obj.hasOwnProperty('id')) {
                this.$http.post(`/productionexe/cuttingprodparams/save`, obj).then(({ code }) => {
                ...
                this.$http.put(`/productionexe/cuttingprodparams/updateById`, obj).then(() => {
