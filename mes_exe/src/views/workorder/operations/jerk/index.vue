                    ...
                    dl
                        ...
                        dd
                            ...
                            el-button(@click="open('Record')" :disabled="workcenter.state!=='1'")
                                i.iconfont.icondata
                                |过程记录
                            el-button(@click="open('rundlet')" :disabled="workcenter.state!=='1'")
                                i.iconfont.icondata
                                |转小桶
            ...
            .wrap
                ...
                .wrap-functions
                    dl
                        dt.middle 操作
                        dd
                            el-button(@click="open('stir')" :disabled="workcenter.state!=='1'")
                                i.iconfont.icondata
                                |搅拌启动
                            //el-button(@click="open('stir')" :disabled="workcenter.state!=='1'")
                                i.iconfont.icondata
                                |搅拌停止
                            el-button(@click="open('stirOver')" :disabled="workcenter.state!=='1'")
                                i.iconfont.icondata
                                |搅拌完成
        ebrain-box.bottom
